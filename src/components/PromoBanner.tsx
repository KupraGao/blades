  ...
  return (
    <section className="section-pad">
      <div className="container-page">
        <div className="relative overflow-hidden rounded-[2rem] border border-zinc-200 bg-gradient-to-r from-white via-zinc-50 to-orange-100 dark:border-brand-gold/20 dark:from-zinc-950 dark:via-zinc-900 dark:to-orange-950 p-8 shadow-premium sm:p-12">
