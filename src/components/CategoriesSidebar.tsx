...
export function CategoriesSidebar({
  ...
  const safeSelectedCategory = selectedCategory || null;
  const safeOnSelectCategory = onSelectCategory || (() => {});
    ...
    <aside className="hidden lg:block fixed top-[80px] left-0 w-full z-[41] pointer-events-none">
      <div className="container-page relative pointer-events-auto">
        <div className="absolute left-7 w-64">
          <div className="overflow-hidden rounded-2xl border border-black shadow-xl">
            <button
              type="button"
              ...
              <div className="overflow-hidden">
                <nav className="flex flex-col">
                  ...
                  {safeCategories.map((item) => {
                    const isActive = safeSelectedCategory === item;
